...
function starter_enqueues_scripts() {
	...
	wp_enqueue_script( 'starter', get_template_directory_uri() . '/assets/js/starter.js', array(), filemtime( get_stylesheet_directory() . '/assets/js/starter.js' ), true );
	wp_localize_script( 'starter', 'starter_ajax', array( 'ajax_url' => admin_url( 'admin-ajax.php' ) ) );
