...
2. #### Content images
    ...
    *If you are not familiar with **image srcset and sizes attributes** it could be complicated to understand fast, but in fact it's very easy to use in Starter theme - you can to see [example how to use](#content_img_example) firstly.*
